...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        System.out.println(ANSI_RED + "textures/models/armor/" + new ResourceLocation("sapphire").getPath() + "_layer_" + ANSI_RESET);
        ...
        //seams to be the item in inventory jsons
    ...
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = TamwynsMod.MOD_ID;
